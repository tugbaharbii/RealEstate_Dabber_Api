...
using RealEstate__Dabber__UI.Dtos.MessageDtos;
using RealEstate__Dabber__UI.Services;

namespace RealEstate__Dabber__UI.Areas.EstateAgent.ViewComponents.EstateAgentNavbarViewComponent
{
	public class _NavbarLast3MessageComponentPartial:ViewComponent
	{
		...
		public async Task< IViewComponentResult> InvokeAsync() 
		{
			...
			var responseMessage = await client.GetAsync("https://localhost:44325/api/Messages?id=" + id);
